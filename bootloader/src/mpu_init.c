...
#define MPU_FLASH_FIRMWARE_FLAG_RW MPU_RGN_SIZE_19K | MPU_RGN_PERM_NOEXEC | MPU_RGN_PERM_PRV_RW_USR_RW | MPU_RGN_ENABLE
#define MPU_FLASH_FIRMWARE_FLAG_RO MPU_RGN_SIZE_19K | MPU_RGN_PERM_NOEXEC | MPU_RGN_PERM_PRV_RO_USR_RO | MPU_RGN_ENABLE
#define MPU_FLASH_FLIGHT_CFG_FLAG_RW MPU_RGN_SIZE_64K | MPU_RGN_PERM_NOEXEC | MPU_RGN_PERM_PRV_RW_USR_RW | MPU_RGN_ENABLE
#define MPU_FLASH_FLIGHT_CFG_FLAG_RO MPU_RGN_SIZE_64K | MPU_RGN_PERM_NOEXEC | MPU_RGN_PERM_PRV_RO_USR_RO | MPU_RGN_ENABLE
#define MPU_SRAM_FIRMWARE_FLAG MPU_RGN_SIZE_16K | MPU_RGN_PERM_EXEC | MPU_RGN_PERM_PRV_RW_USR_RW | MPU_RGN_ENABLE
